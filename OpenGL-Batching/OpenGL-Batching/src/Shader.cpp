...
// Shader uniforms
void Shader::setUniformVec2f(const char* uniName, const vec2& vec)
{
...
void Shader::setUniformVec3f(const char* uniName, const vec3& vec)
{
	int location = glGetUniformLocation(p_shaderID, uniName);
	if (location <= -1)
	{
...
void Shader::setUniformVec4f(const char* uniName, const vec4& vec)
{
	int location = glGetUniformLocation(p_shaderID, uniName);
	if (location <= -1)
	{
...
void Shader::setUniformMat4f(const char* uniName, const mat4& mat)
{
	int location = glGetUniformLocation(p_shaderID, uniName);
	if (location <= -1)
	{
